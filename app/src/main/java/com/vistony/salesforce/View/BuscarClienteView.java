...
public class BuscarClienteView extends Fragment implements SearchView.OnQueryTextListener {
    ...
    public static BuscarClienteView newInstanciaEnviarClienteKardexOfPayment(Object param1) {
        BuscarClienteView fragment = new BuscarClienteView();
    ...
    public static BuscarClienteView newInstanciaSendCustomerComplaint(Object param1) {
        BuscarClienteView fragment = new BuscarClienteView();
