 ...
 * Use the {@link HistoricoOrdenVentaEstadoPendRevView#newInstance} factory method to
 * create an instance of this fragment.
 */
public class HistoricoOrdenVentaEstadoPendRevView extends Fragment {
    ...
    View v;
    ListView lv_historico_orden_venta_pend_rev;
    ListaHistoricoOrdenVentaAdapter listaHistoricoOrdenVentaAdapter;
    public HistoricoOrdenVentaEstadoPendRevView() {
     ...
     * @return A new instance of fragment HistoricoOrdenVentaEstadoPendRevView.
     */
    // TODO: Rename and change types and number of parameters
    public static HistoricoOrdenVentaEstadoPendRevView newInstance(String param1, String param2) {
        HistoricoOrdenVentaEstadoPendRevView fragment = new HistoricoOrdenVentaEstadoPendRevView();
    ...
    public void onCreate(Bundle savedInstanceState) {
        Log.e("REOS","HistoricoOrdenVentaEstadoPendRevView:Inicio");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v= inflater.inflate(R.layout.fragment_historico_orden_venta_estado_pend_rev_view, container, false);
        lv_historico_orden_venta_pend_rev=v.findViewById(R.id.lv_historico_orden_venta_pend_rev);
        CargarHistoricoOrdenVentaEstadoPendRev();
        return v;
    }

    public void CargarHistoricoOrdenVentaEstadoPendRev()
    {
...
//        Log.e("REOS","HistoricoOrdenVentaEstadoPendRevView:HistoricoOrdenVentaEstadoView.Lista.size()"+HistoricoOrdenVentaEstadoView.Lista.size());
        ...
        {
            if(HistoricoOrdenVentaEstadoView.Lista.get(i).getEstadoaprobacion().equals("Pendiente Revision"))
            {
        ...
        lv_historico_orden_venta_pend_rev.setAdapter(listaHistoricoOrdenVentaAdapter);
    }
