 ...
 * Use the {@link HistoricoOrdenVentaEstadoRechazadoView#newInstance} factory method to
 * create an instance of this fragment.
 */
public class HistoricoOrdenVentaEstadoRechazadoView extends Fragment {
    ...
    ListView lv_historico_orden_venta_estado_rechazado;
    ListaHistoricoOrdenVentaAdapter listaHistoricoOrdenVentaAdapter;
    View v;
    public HistoricoOrdenVentaEstadoRechazadoView() {
     ...
     * @return A new instance of fragment HistoricoOrdenVentaEstadoRechazadoView.
     */
    // TODO: Rename and change types and number of parameters
    public static HistoricoOrdenVentaEstadoRechazadoView newInstance(String param1, String param2) {
        HistoricoOrdenVentaEstadoRechazadoView fragment = new HistoricoOrdenVentaEstadoRechazadoView();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v= inflater.inflate(R.layout.fragment_historico_orden_venta_estado_rechazado_view, container, false);
        lv_historico_orden_venta_estado_rechazado=v.findViewById(R.id.lv_historico_orden_venta_estado_rechazado);
        CargarHistoricoOrdenVentaEstadoRechazado();
        return v;
    }

    public void CargarHistoricoOrdenVentaEstadoRechazado()
    {
...
//        Log.e("REOS","HistoricoOrdenVentaEstadoPendRevView:HistoricoOrdenVentaEstadoView.Lista.size()"+HistoricoOrdenVentaEstadoView.Lista.size());
        ...
        {
            if(HistoricoOrdenVentaEstadoView.Lista.get(i).getEstadoaprobacion().equals("Rechazado"))
            {
        ...
        lv_historico_orden_venta_estado_rechazado.setAdapter(listaHistoricoOrdenVentaAdapter);
    }
}