 ...
 * Use the {@link HistoricoOrdenVentaEstadoAprobacionView#newInstance} factory method to
 * create an instance of this fragment.
 */
public class HistoricoOrdenVentaEstadoAprobacionView extends Fragment {
    ...
    View v;
    ListView lv_historico_orden_venta_estado_aprobacion;
    ListaHistoricoOrdenVentaAdapter listaHistoricoOrdenVentaAdapter;
    public HistoricoOrdenVentaEstadoAprobacionView() {
     ...
     * @return A new instance of fragment HistoricoOrdenVentaEstadoAprobacionView.
     */
    // TODO: Rename and change types and number of parameters
    public static HistoricoOrdenVentaEstadoAprobacionView newInstance(String param1, String param2) {
        HistoricoOrdenVentaEstadoAprobacionView fragment = new HistoricoOrdenVentaEstadoAprobacionView();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v= inflater.inflate(R.layout.fragment_historico_orden_venta_estado_aprobacion_view, container, false);
        lv_historico_orden_venta_estado_aprobacion=v.findViewById(R.id.lv_historico_orden_venta_estado_aprobacion);
        CargarHistoricoOrdenVentaEstadoAprobacion();
        return v;
    }

    public void CargarHistoricoOrdenVentaEstadoAprobacion()
    {
...
//        Log.e("REOS","HistoricoOrdenVentaEstadoPendRevView:HistoricoOrdenVentaEstadoView.Lista.size()"+HistoricoOrdenVentaEstadoView.Lista.size());
        ...
        {
            if(HistoricoOrdenVentaEstadoView.Lista.get(i).getEstadoaprobacion().equals("Aprobado"))
            {
        ...
        lv_historico_orden_venta_estado_aprobacion.setAdapter(listaHistoricoOrdenVentaAdapter);
    }
}