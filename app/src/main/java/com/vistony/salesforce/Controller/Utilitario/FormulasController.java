...
import static com.vistony.salesforce.Controller.Utilitario.Convert.getScale;
...
public class FormulasController {
    ...
    public String CalcularMontoTotalporLinea(String MontoSubTotalSinDescuento, String MontoDescuento, String MontoImpuesto) {
        ...
        BigDecimal xd1 = new BigDecimal(MontoSubTotalSinDescuento).setScale(getScale(), RoundingMode.HALF_UP);
        BigDecimal xd2 = new BigDecimal(MontoDescuento).setScale(getScale(), RoundingMode.HALF_UP);
    ...
    public String CalcularMontoImpuestoPorLinea(String MontoSubtotal, String MontoDescuento, String Impuesto) {
        BigDecimal xd1 = new BigDecimal(MontoSubtotal).setScale(getScale(), RoundingMode.HALF_UP);
        BigDecimal xd2 = new BigDecimal(MontoDescuento).setScale(getScale(), RoundingMode.HALF_UP);
    ...
    public String getTotalPerLine(String PrecioUnitario, String Cantidad) {
        ...
        BigDecimal preUnit = new BigDecimal(PrecioUnitario).setScale(getScale(), RoundingMode.HALF_UP);
    ...
    public TotalSalesOrder CalcularMontosPedidoCabeceraDetallePromocion(ArrayList<ListaOrdenVentaDetalleEntity> listaOrdenVentaDetalleEntity) {
        ...
        BigDecimal CalculoSubTotal = new BigDecimal(ObtenerCalculoMontoSubTotalOrdenDetallePromocion(listaOrdenVentaDetalleEntity)).setScale(getScale(), RoundingMode.HALF_UP);
        BigDecimal CalculoTotalDsct = new BigDecimal(CalculoTotalDescuento).setScale(getScale(), RoundingMode.HALF_UP);

        CalculoTotalIGV = "" + CalculoSubTotal.subtract(CalculoTotalDsct).multiply(new BigDecimal(Induvis.getImpuestoDouble())).setScale(getScale(), RoundingMode.HALF_UP);
        CalculoTotal = CalculoSubTotal.subtract(CalculoTotalDsct).add(new BigDecimal(CalculoTotalIGV)).setScale(getScale(), RoundingMode.HALF_UP).toString();
    ...
    public String CalcularMontoImpuestoOrdenDetallePromocionLinea(ListaOrdenVentaDetalleEntity lead) {
        ...
        if (lead.getOrden_detalle_lista_orden_detalle_promocion() != null) {
            for (int i = 0; i < lead.getOrden_detalle_lista_orden_detalle_promocion().size(); i++) {
                ...
                calculoImpuesto = calculoImpuesto.add(new BigDecimal(lead.getOrden_detalle_lista_orden_detalle_promocion().get(i).getOrden_detalle_monto_igv()).setScale(getScale(), RoundingMode.HALF_UP));
            }
        }
    ...
    public String ObtenerCalculoDescuentoOrdenDetallePromocion(ArrayList<ListaOrdenVentaDetalleEntity> Lista) {
        ...
        return cacculoDsct.setScale(getScale(), RoundingMode.HALF_UP).toString();
    }
    ...
    public String ObtenerCalculoMontoSubTotalOrdenDetallePromocion(ArrayList<ListaOrdenVentaDetalleEntity> Lista) {
        ...
        return "" + acum.setScale(getScale(), RoundingMode.HALF_UP);
    }
    ...
    public String GenerayConvierteaJSONOV(String ordenventa_id, Context context) {
        ...
        for (int j = 0; j < listaordenVentaDetalleSQLiteEntity.size(); j++) {
            ...
            switch (BuildConfig.FLAVOR)
            {
                ...
                case "bolivia":
                case "paraguay":
                    taxCode=SesionEntity.Impuesto_ID;
                    COGSAccountCode=SesionEntity.cogsacct;
                    taxOnly="N";
                    U_VIST_CTAINGDCTO=SesionEntity.u_vist_ctaingdcto;
                    PercentDescnt = listaordenVentaDetalleSQLiteEntity.get(j).getPorcentajedescuento();
                    //Casuistica Bonificacion
    ...
    public String CalcularMontoTotalPromocionconDescuentoyBono(String MontoTotalLineaSinDescuento, String MontoDescuento, String Bono) {
        ...
        BigDecimal repta = temp1.subtract(new BigDecimal(MontoDescuento)).subtract(new BigDecimal(Bono).setScale(getScale(), RoundingMode.HALF_UP));
            ...
            )
    {
        ...
        for(int j=0;j<listaOrdenVentaDetalleEntities.size();j++)
        {
            ...
            Log.e("REOS", "FormulasController-addSIGAUS-listaOrdenVentaDetalleEntities.get(j).getOrden_detalle_oil_tax(): "+listaOrdenVentaDetalleEntities.get(j).getOrden_detalle_oil_tax());
        ...
        if(SIGAUS==0)
        {
            ...
            ObjListaProductosEntity.orden_detalle_SIGAUS = "Y";
