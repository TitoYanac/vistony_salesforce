...
import com.vistony.salesforce.View.HistoricPromotionView;
...
public class ListHistoricPromotionAdapter extends ArrayAdapter<ListaConsultaStockEntity>
{
    ...
    public ListHistoricPromotionAdapter(android.content.Context context, List<ListaConsultaStockEntity> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ListHistoricPromotionAdapter.ViewHolder holder;

        // ¿Ya se infló este view?
        if (null == convertView) {


            convertView = inflater.inflate(R.layout.layout_list_historic_promotion,parent,false);
            holder = new ListHistoricPromotionAdapter.ViewHolder();
            ...
            holder = (ListHistoricPromotionAdapter.ViewHolder) convertView.getTag();
        }
        ...
        holder.imv_enable_promotion.setOnClickListener(v -> {
                    ...
                    switch (BuildConfig.FLAVOR){
                        ...
                        case "marruecos":
                            ...
                            HistoricPromotionView.newInstanceEnviarPromocion(listaListadoPromocionCabeceraEntity);
