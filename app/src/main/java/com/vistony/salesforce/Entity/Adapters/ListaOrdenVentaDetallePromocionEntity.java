...
public class ListaOrdenVentaDetallePromocionEntity {
    ...
    public ArrayList<ListaOrdenVentaDetalleEntity> orden_detalle_lista_orden_detalle_promocion;
    public String orden_detalle_promocion_item;
    public String orden_detalle_linea_padre;
    public String orden_detalle_linea_referencia_padre;
    public String orden_detalle_promocion_id;
    ...
    public ListaOrdenVentaDetallePromocionEntity(String orden_detalle_item, String orden_detalle_producto_id, String orden_detalle_producto, String orden_detalle_umd, String orden_detalle_stock, String orden_detalle_cantidad, String orden_detalle_precio_unitario, String orden_detalle_montosubtotal, String orden_detalle_porcentaje_descuento, String orden_detalle_monto_descuento, String orden_detalle_monto_igv, String orden_detalle_montototallinea, ArrayList<ListaPromocionCabeceraEntity> orden_detalle_lista_promocion_cabecera, String orden_detalle_promocion_habilitada, String orden_detalle_gal, String orden_detalle_gal_acumulado, String orden_detalle_montosubtotalcondescuento, ArrayList<ListaOrdenVentaDetalleEntity> orden_detalle_lista_orden_detalle_promocion, String orden_detalle_promocion_item, String orden_detalle_linea_padre, String orden_detalle_linea_referencia_padre, String orden_detalle_promocion_id, String orden_detalle_descuentocontado, boolean orden_detalle_chk_descuentocontado, String orden_detalle_terminopago_id, boolean orden_detalle_chk_descuentocontado_aplicado) {
        ...
        this.orden_detalle_promocion_item = orden_detalle_promocion_item;
        this.orden_detalle_linea_padre = orden_detalle_linea_padre;
        this.orden_detalle_linea_referencia_padre = orden_detalle_linea_referencia_padre;
        this.orden_detalle_promocion_id = orden_detalle_promocion_id;
    ...
    public ListaOrdenVentaDetallePromocionEntity() {
    ...
    public String getOrden_detalle_promocion_id() {
        return orden_detalle_promocion_id;
    }

    public void setOrden_detalle_promocion_id(String orden_detalle_promocion_id) {
        this.orden_detalle_promocion_id = orden_detalle_promocion_id;
    }

    public String getOrden_detalle_linea_referencia_padre() {
        return orden_detalle_linea_referencia_padre;
    }

    public void setOrden_detalle_linea_referencia_padre(String orden_detalle_linea_referencia_padre) {
        this.orden_detalle_linea_referencia_padre = orden_detalle_linea_referencia_padre;
    }

    public String getOrden_detalle_linea_padre() {
        return orden_detalle_linea_padre;
    }

    public void setOrden_detalle_linea_padre(String orden_detalle_linea_padre) {
        this.orden_detalle_linea_padre = orden_detalle_linea_padre;
    }
    ...
    public ArrayList<ListaOrdenVentaDetalleEntity> getOrden_detalle_lista_orden_detalle_promocion() {
        return orden_detalle_lista_orden_detalle_promocion;
    }

    public void setOrden_detalle_lista_orden_detalle_promocion(ArrayList<ListaOrdenVentaDetalleEntity> orden_detalle_lista_orden_detalle_promocion) {
        this.orden_detalle_lista_orden_detalle_promocion = orden_detalle_lista_orden_detalle_promocion;
    }

    public String getOrden_detalle_promocion_item() {
        return orden_detalle_promocion_item;
    }

    public void setOrden_detalle_promocion_item(String orden_detalle_promocion_item) {
        this.orden_detalle_promocion_item = orden_detalle_promocion_item;
    }
}
