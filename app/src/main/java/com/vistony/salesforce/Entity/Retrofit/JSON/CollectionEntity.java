package com.vistony.salesforce.Entity.Retrofit.JSON;
...
public class CollectionEntity {
    ...
    public String getDocEntryFT() {
        return DocEntryFT;
    }

    public void setDocEntryFT(String docEntryFT) {
        DocEntryFT = docEntryFT;
    }
