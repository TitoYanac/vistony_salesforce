...
public class UsuarioSQLiteEntity {
    ...
    public String chksesion;
    public String online;
    public String perfil;
    public String chkbloqueopago;
    ...
    public String getChkbloqueopago() {
        return chkbloqueopago;
    }

    public void setChkbloqueopago(String chkbloqueopago) {
    ...
    public String getChksesion() {
        return chksesion;
    }

    public void setChksesion(String chksesion) {
