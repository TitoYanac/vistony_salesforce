...
public class OrdenVentaCabeceraSQLite {
    ...
    public ArrayList<OrdenVentaCabeceraSQLiteEntity> ObtenerOrdenVentaCabeceraporFecha (String fecha,String fuerzatrabajo_id,String compania_id)
    {
        ...
        abrir();
        Log.e("REOS","OrdenVentaCabeceraSQLite-ObtenerOrdenVentaCabeceraporFecha-fecha:"+fecha);
        Log.e("REOS","OrdenVentaCabeceraSQLite-ObtenerOrdenVentaCabeceraporFecha-fuerzatrabajo_id:"+fuerzatrabajo_id);
        Log.e("REOS","OrdenVentaCabeceraSQLite-ObtenerOrdenVentaCabeceraporFecha-compania_id:"+compania_id);
    ...
    public ArrayList<String> ObtenerOrdenVentaCabeceraPendientesEnvioWS ()
    {
        ...
        abrir();
        try {
            Cursor fila = bd.rawQuery("Select ordenventa_id  from ordenventacabecera where recibidoERP is null or recibidoERP='0' and enviadoERP='1' and substr(ordenventa_id,1,8)>='20230601'  ",null);
    ...
    public ArrayList<OrdenVentaCabeceraSQLiteEntity> getSalesOrderPendingSAP (){
        listaOrdenVentaCabeceraSQLiteEntity = new ArrayList<OrdenVentaCabeceraSQLiteEntity>();
        OrdenVentaCabeceraSQLiteEntity ordenVentaCabeceraSQLiteEntity;
        ...
        try{
            ...
            Cursor fila = bd.rawQuery("SELECT compania_id,ordenventa_id,cliente_id,domembarque_id,domfactura_id,terminopago_id," +
                    ...
                    " FROM ordenventacabecera WHERE recibidoERP is null or recibidoERP='0' and enviadoERP='1' ",null );
            if (fila.moveToFirst()) {
                do {
                    ordenVentaCabeceraSQLiteEntity= new OrdenVentaCabeceraSQLiteEntity();
    ...
    public int UpdateOVJSON (String ordenventa_id,String JSON)
    {
        int resultado=0;
        abrir();
        try {
