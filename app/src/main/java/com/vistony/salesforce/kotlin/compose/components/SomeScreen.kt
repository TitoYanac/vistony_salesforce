package com.vistony.salesforce.features.featureone
...
//import com.karthik.scribblecompose.components.CompleteDialogContent
import com.vistony.salesforce.kotlin.compose.components.CompleteDialogContent
import com.vistony.salesforce.kotlin.compose.components.SomeScreenViewModel


@Composable
    fun DialogScreenOne2(dvm: SomeScreenViewModel = viewModel()) {
        ...
        Log.e(
            "REOS",
            "SomeScreen-DialogScreenOne()-fin"
        )
    }
