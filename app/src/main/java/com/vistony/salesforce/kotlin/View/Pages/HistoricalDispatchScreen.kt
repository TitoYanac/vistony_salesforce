...
import com.vistony.salesforce.kotlin.View.Template.HistoricalDispatchTemplate

class HistoricalDispatchScreen: Fragment()  {
    override fun onCreateView(
        ...
        return ComposeView(requireContext()).apply {
            setContent {
                requireActivity().title = "Consulta Despachos"
                VistonyTheme() {
