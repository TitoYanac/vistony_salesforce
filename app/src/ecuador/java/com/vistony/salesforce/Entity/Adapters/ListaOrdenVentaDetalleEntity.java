...
public class ListaOrdenVentaDetalleEntity implements Serializable  {
    ...
    public String orden_detalle_stock_general;
    ...
    public ListaOrdenVentaDetalleEntity(
            ...
            String orden_detalle_umd, String orden_detalle_stock_almacen,String orden_detalle_stock_general,
            String orden_detalle_cantidad, String orden_detalle_precio_unitario,
            String orden_detalle_montosubtotal, String orden_detalle_porcentaje_descuento,
            String orden_detalle_monto_descuento, String orden_detalle_monto_igv,
            String orden_detalle_montototallinea, ArrayList<ListaPromocionCabeceraEntity> orden_detalle_lista_promocion_cabecera,
            String orden_detalle_promocion_habilitada, String orden_detalle_gal, String orden_detalle_gal_acumulado, String orden_detalle_montosubtotalcondescuento, ArrayList<ListaOrdenVentaDetallePromocionEntity> orden_detalle_lista_orden_detalle_promocion, String orden_detalle_descuentocontado, boolean orden_detalle_chk_descuentocontado, String orden_detalle_terminopago_id
        ...
        this.orden_detalle_stock_general = orden_detalle_stock_general;
    ...
    public String getOrden_detalle_stock_general() {
        return orden_detalle_stock_general;
    }

    public void setOrden_detalle_stock_general(String orden_detalle_stock_general) {
        this.orden_detalle_stock_general = orden_detalle_stock_general;
    }
