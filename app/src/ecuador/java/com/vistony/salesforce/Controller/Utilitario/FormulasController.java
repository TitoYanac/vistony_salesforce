...
public class FormulasController {
    ...
    public String suma(String num1,String num2){
        ...
        return rpta.setScale(6, RoundingMode.HALF_UP).toString();
    }
    ...
    public String CalcularMontoTotalconDescuento(String MontoTotalLineaSinDescuento,String MontoDescuento){
        ...
        BigDecimal repta=temp1.subtract(new BigDecimal(MontoDescuento)).setScale(6, RoundingMode.HALF_UP);
    ...
    public String CalcularMontoTotalporLinea(String MontoSubTotalSinDescuento,String MontoDescuento,String MontoImpuesto) {
        ...
        BigDecimal xd1=new BigDecimal(MontoSubTotalSinDescuento).setScale(6, RoundingMode.HALF_UP);
        BigDecimal xd2=new BigDecimal(MontoDescuento).setScale(6, RoundingMode.HALF_UP);
    ...
    public String CalcularMontoImpuestoPorLinea(String MontoSubtotal,String MontoDescuento,String Impuesto){
        BigDecimal xd1=new BigDecimal(MontoSubtotal).setScale(6, RoundingMode.HALF_UP);
        BigDecimal xd2=new BigDecimal(MontoDescuento).setScale(6, RoundingMode.HALF_UP);
    ...
    public String applyDiscountPercentageForLine(String MontoTotalLineaSinIGV,String PorcentajeDescuento) {
        ...
        BigDecimal montoDescuento=monto.multiply(porcentaje).divide(new BigDecimal(100),6,RoundingMode.HALF_UP);
    ...
    public TotalSalesOrder CalcularMontosPedidoCabeceraDetallePromocion(ArrayList<ListaOrdenVentaDetalleEntity> listaOrdenVentaDetalleEntity){
        ...
        BigDecimal CalculoSubTotal=new BigDecimal(ObtenerCalculoMontoSubTotalOrdenDetallePromocion(listaOrdenVentaDetalleEntity)).setScale(6,RoundingMode.HALF_UP);
        BigDecimal CalculoTotalDsct=new BigDecimal(CalculoTotalDescuento).setScale(6,RoundingMode.HALF_UP);

        CalculoTotalIGV=""+CalculoSubTotal.subtract(CalculoTotalDsct).multiply( new BigDecimal(Induvis.getImpuestoDouble())).setScale(6,RoundingMode.HALF_UP);
        CalculoTotal=CalculoSubTotal.subtract(CalculoTotalDsct).add(new BigDecimal(CalculoTotalIGV)).setScale(6,RoundingMode.HALF_UP).toString();
    ...
    public String CalcularMontoImpuestoOrdenDetallePromocionLinea(ListaOrdenVentaDetalleEntity lead){
        ...
        if(lead.getOrden_detalle_lista_orden_detalle_promocion()!=null){
            for(int i=0;i<lead.getOrden_detalle_lista_orden_detalle_promocion().size();i++){
                calculoImpuesto=calculoImpuesto.add(new BigDecimal(lead.getOrden_detalle_lista_orden_detalle_promocion().get(i).getOrden_detalle_monto_igv()).setScale(6,RoundingMode.HALF_UP));
            }
        }
    ...
    public String ObtenerCalculoDescuentoOrdenDetallePromocion(ArrayList<ListaOrdenVentaDetalleEntity> Lista){
        ...
        return cacculoDsct.setScale(6, RoundingMode.HALF_UP).toString();
    }
    */
    ...
    public String ObtenerCalculoMontoSubTotalOrdenDetallePromocion(ArrayList<ListaOrdenVentaDetalleEntity> Lista){
        ...
        return ""+acum.setScale(6, RoundingMode.HALF_UP);
    }
    ...
    public String GenerayConvierteaJSONOV (String ordenventa_id,Context context){
       ...
       if(Integer.parseInt(ovCabecera.getDueDays())>5){ //NO CUMPLE CON LA VALIDACIÓN DE DOCUMENTOS VENCIDOS
        ...
        for(int j=0;j<listaordenVentaDetalleSQLiteEntity.size();j++){
            String COGSAccountCode=SesionEntity.cogsacct,U_SYP_FECAT_07="",taxOnly="N",taxCode=SesionEntity.Impuesto_ID,U_VIST_CTAINGDCTO=SesionEntity.u_vist_ctaingdcto,montolineatotal="",discountpercent="",AcctCode="";
            ...
            if(listaordenVentaDetalleSQLiteEntity.get(j).getProducto_id().equals("ECOVALOR"))
            {
                listBusinessLayerSalesDetailDetailEntity=businessLayerSalesDetailDetailDao.getBusinessLayerSalesDetailDetailType("1","7","ECOVALOR");
            }else {
            ...
            for(int g=0;g<listBusinessLayerSalesDetailDetailEntity.size();g++)
            {
                ...
                {
                    //AcctCode=listBusinessLayerSalesDetailDetailEntity.get(g).getVariable();
            ...
            /*if(listaordenVentaDetalleSQLiteEntity.get(j).getPorcentajedescuento().equals("100"))
            {
                documentLine.setDiscountPercent("99.99");
            }
            else {
            ...
            documentLine.setAcctCode(AcctCode);
    ...
    public  String getPriceReferencePack(String PrecioPackconDescuento,String QuantityPackPromotion){
        ...
        BigDecimal resultado=precioPackconDescuento.divide(quantityPackPromotion,2,RoundingMode.HALF_UP);;
        Log.e("REOS","FormulasController.getPriceReferencePack.resultado:" + resultado);
            ...
            )
    {
        ...
        for(int j=0;j<listaOrdenVentaDetalleEntities.size();j++)
        {
            ...
            if(listaOrdenVentaDetalleEntities.get(j).getOrden_detalle_oil_tax() .equals("Y"))
            {
                cantidad=cantidad+
                        (
                                Float.parseFloat(listaOrdenVentaDetalleEntities.get(j).getOrden_detalle_gal_acumulado())
                                /*Float.parseFloat(listaOrdenVentaDetalleEntities.get(j).getOrden_detalle_gal())
                                        *
        ...
        {
            if(listSalesOrder.get(j).getOrden_detalle_producto_id().equals("ECOVALOR"))
            {
                SIGAUS++;
            }
        }
