...
public class BixolonPrinterController implements ErrorListener, OutputCompleteListener, StatusUpdateListener, DirectIOListener, DataListener {
    // ------------------- alignment ------------------- //
    ...
    public void errorOccurred(ErrorEvent errorEvent) {
       /* Fragment fm = MainActivity.getVisibleFragment();
        if (fm != null) {
            ...
            if (fm instanceof ConfigImpresoraView) {
                ((ConfigImpresoraView) fm).setDeviceLog("Error : " + errorEvent);
            }
    ...
    public void outputCompleteOccurred(OutputCompleteEvent outputCompleteEvent) {
        ...
        if (fm != null) {
            if (fm instanceof ConfigImpresoraView) {
                ((ConfigImpresoraView) fm).setDeviceLog("outputComplete : " + outputCompleteEvent.getOutputID());
            }
    ...
    public void statusUpdateOccurred(StatusUpdateEvent statusUpdateEvent) {
        ...
        if (fm != null) {
            if (fm instanceof ConfigImpresoraView) {
                ((ConfigImpresoraView) fm).setDeviceLog(getSUEMessage(statusUpdateEvent.getStatus()));
            }
