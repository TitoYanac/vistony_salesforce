...
public class OrdenVentaCabeceraView extends Fragment implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    public static OrdenVentaCabeceraView newInstanciaRecibirPriceList(Object objeto) {

        ListenerBackPress.setCurrentFragment("FormListClienteDetalleRutaVendedor");
        OrdenVentaCabeceraView ordenVentaView = new OrdenVentaCabeceraView();

        Bundle b = new Bundle();
        listaPriceListEntity = (ListaPriceListEntity) objeto;
        tv_orden_venta_lista_precios.setText(listaPriceListEntity.getPricelist());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            listaPriceListEntity.pricelist_id="";
            listaPriceListEntity.pricelist_id="";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        v= inflater.inflate(R.layout.fragment_orden_venta_cabecera_paraguay, container, false);
        ...
        chk_lista_precios=(CheckBox) v.findViewById(R.id.chk_lista_precios);
        lbl_lista_precio=(TextView) v.findViewById(R.id.lbl_lista_precio);
        tv_orden_venta_lista_precios=(TextView) v.findViewById(R.id.tv_orden_venta_lista_precios);
        ...
        chk_lista_precios.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
              if(chk_lista_precios.isChecked())
                {
                    lbl_lista_precio.setVisibility(View.VISIBLE);
                    tv_orden_venta_lista_precios.setVisibility(View.VISIBLE);
                    btn_consultar_lista_precios.setVisibility(View.VISIBLE);
                    lbl_terminopago.setVisibility(View.GONE);
                    tv_terminopago.setVisibility(View.GONE);
                    btn_consultar_termino_pago.setVisibility(View.GONE);
                }else
                {
                    lbl_lista_precio.setVisibility(View.GONE);
                    tv_orden_venta_lista_precios.setVisibility(View.GONE);
                    btn_consultar_lista_precios.setVisibility(View.GONE);
                    lbl_terminopago.setVisibility(View.VISIBLE);
                    tv_terminopago.setVisibility(View.VISIBLE);
                    btn_consultar_termino_pago.setVisibility(View.VISIBLE);
        ...
        btn_consultar_lista_precios.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String Fragment="OrdenVentaCabeceraView";
                String accion="pricelist";
