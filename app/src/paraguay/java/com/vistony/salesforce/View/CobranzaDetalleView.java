                ...
                /*else
                {
                    ...
                    if (p <= 1&&q>=1) {
                        ...
                        if (!(montoIngresado.compareTo(BigDecimal.ZERO) > 0)) {
                            ...
                            if (chkpagoadelantado.isChecked()) {
                                Log.e("REOS", "CobranzaDetalleView-imaaceptar-chkpagoadelantado.isChecked()"+chkpagoadelantado.isChecked());
                                for (int j = 0; j < listaClienteDetalleAdapterFragment.size(); j++) {

                                    cobrado = montoCobrado;
                                    Log.e("REOS", "CobranzaDetalleView-imaaceptar-montoCobrado"+montoCobrado);
