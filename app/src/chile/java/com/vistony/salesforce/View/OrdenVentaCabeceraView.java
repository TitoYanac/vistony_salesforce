...
public class OrdenVentaCabeceraView extends Fragment {
    ...
    public static OrdenVentaCabeceraView newInstanciaTerminoPago(Object objeto) {
        ...
        for(int i=0;i<ListaTerminoPago.size();i++){
            ...
            Log.e("REOS","OrdenCabeceraView-newInstanciaTerminoPago-terminopago_id:"+terminopago_id);
            Log.e("REOS","OrdenCabeceraView-newInstanciaTerminoPago-terminopago:"+terminopago);
            Log.e("REOS","OrdenCabeceraView-newInstanciaTerminoPago-contado:"+contado);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        switch (BuildConfig.FLAVOR){
            ...
            case "ecuador":
                ...
                break;
            case "chile":
                v= inflater.inflate(R.layout.fragment_orden_venta_cabecera_chile, container, false);
                break;
            case "peru":
    ...
    */
    ...
    private Dialog alertaCrearOrdenVenta(String texto) {
        ...
        dialogButtonOK.setOnClickListener(v -> {
            ...
            ///////////AQui//////////////
            Log.e("REOS","OrdenCabeceraView-alertaCrearOrdenVenta-cliente_terminopago_id:"+cliente_terminopago_id);
            Log.e("REOS","OrdenCabeceraView-alertaCrearOrdenVenta-cantidaddescuento:"+cantidaddescuento);
            Log.e("REOS","OrdenCabeceraView-alertaCrearOrdenVenta-codigocliente:"+codigocliente);
