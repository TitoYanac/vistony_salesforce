...
public class FormulasController {
    ...
    public String CalcularMontoTotalconDescuento(String MontoTotalLineaSinDescuento,String MontoDescuento){
        ...
        BigDecimal repta=temp1.subtract(new BigDecimal(MontoDescuento)).setScale(0, RoundingMode.HALF_UP);
    ...
    public String CalcularMontoTotalporLinea(String MontoSubTotalSinDescuento,String MontoDescuento,String MontoImpuesto) {
        ...
        BigDecimal xd1=new BigDecimal(MontoSubTotalSinDescuento).setScale(0, RoundingMode.HALF_UP);
        BigDecimal xd2=new BigDecimal(MontoDescuento).setScale(0, RoundingMode.HALF_UP);
    ...
    public String CalcularMontoImpuestoPorLinea(String MontoSubtotal,String MontoDescuento,String Impuesto){
        BigDecimal xd1=new BigDecimal(MontoSubtotal).setScale(0, RoundingMode.HALF_UP);
        BigDecimal xd2=new BigDecimal(MontoDescuento).setScale(0, RoundingMode.HALF_UP);
    ...
    public String getTotalPerLine(String PrecioUnitario,String Cantidad){
        ...
        BigDecimal preUnit = new BigDecimal(PrecioUnitario).setScale(0,RoundingMode.HALF_UP);
    ...
    public String applyDiscountPercentageForLine(String MontoTotalLineaSinIGV,String PorcentajeDescuento) {
        ...
        BigDecimal montoDescuento=monto.multiply(porcentaje).divide(new BigDecimal(100),0,RoundingMode.HALF_UP);
    ...
    public TotalSalesOrder CalcularMontosPedidoCabeceraDetallePromocion(ArrayList<ListaOrdenVentaDetalleEntity> listaOrdenVentaDetalleEntity){
        ...
        BigDecimal CalculoSubTotal=new BigDecimal(ObtenerCalculoMontoSubTotalOrdenDetallePromocion(listaOrdenVentaDetalleEntity)).setScale(0,RoundingMode.HALF_UP);
        BigDecimal CalculoTotalDsct=new BigDecimal(CalculoTotalDescuento).setScale(0,RoundingMode.HALF_UP);

        CalculoTotalIGV=""+CalculoSubTotal.subtract(CalculoTotalDsct).multiply( new BigDecimal(Induvis.getImpuestoDouble())).setScale(0,RoundingMode.HALF_UP);
        CalculoTotal=CalculoSubTotal.subtract(CalculoTotalDsct).add(new BigDecimal(CalculoTotalIGV)).setScale(0,RoundingMode.HALF_UP).toString();
    ...
    public String CalcularMontoImpuestoOrdenDetallePromocionLinea(ListaOrdenVentaDetalleEntity lead){
        ...
        if(lead.getOrden_detalle_lista_orden_detalle_promocion()!=null){
            for(int i=0;i<lead.getOrden_detalle_lista_orden_detalle_promocion().size();i++){
                calculoImpuesto=calculoImpuesto.add(new BigDecimal(lead.getOrden_detalle_lista_orden_detalle_promocion().get(i).getOrden_detalle_monto_igv()).setScale(0,RoundingMode.HALF_UP));
            }
        }
    ...
    public String ObtenerCalculoDescuentoOrdenDetallePromocion(ArrayList<ListaOrdenVentaDetalleEntity> Lista){
        ...
        return cacculoDsct.setScale(0, RoundingMode.HALF_UP).toString();
    }
    ...
    public String ObtenerCalculoMontoSubTotalOrdenDetallePromocion(ArrayList<ListaOrdenVentaDetalleEntity> Lista){
        ...
        return ""+acum.setScale(0, RoundingMode.HALF_UP);
    }
