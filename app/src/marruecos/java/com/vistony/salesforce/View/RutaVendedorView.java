...
public class RutaVendedorView extends Fragment //implements SearchView.OnQueryTextListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().setTitle(this.getResources().getString(R.string.menu_ruta_vendedor));
        ...
        if(SesionEntity.Print.equals("Y"))
        {
            ...
            for(int i=0;i<arraylistConfiguracionentity.size();i++)
            {
                ...
                {
                    Toast.makeText(getContext(), getContext().getResources().getString(R.string.msn_configuration_blueetohh), Toast.LENGTH_SHORT).show();
                }
